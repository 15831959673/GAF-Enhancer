...
def fine_tune(new_model,  new_model_y, new_model_y_eval, old_model, args, eps=1e-5):
    ...
    for epoch_num in range(args.num_epochs):
        ...
        for _step in range(args.num_accum_steps):
            ...
            if epoch_num == 1:
                np.save('sample_800.npy', sample2.detach().cpu().numpy())
                print('保存成功')
...
argparser.add_argument('--base_path', type=str, default='/home/zhl/workspace/DRAKES/data/scratch/wangchy/seqft/')
argparser.add_argument('--learning_rate', type=float, default=1e-4)
argparser.add_argument('--num_epochs', type=int, default=1000)
argparser.add_argument('--num_accum_steps', type=int, default=8)
...
CKPT_PATH = '/home/zhl/workspace/DRAKES/drakes_dna/data/scratch/wangchy/seqft/mdlm/outputs_gosai/2025.03.24/184740/checkpoints/167-131500.ckpt'
...
set_seed(args.seed, use_cuda=True, device="cuda:1")
...
# sample1 = new_model._sample(eval_sp_size=8)
# sample2, last_x_list, condt_list, move_chance_t_list, copy_flag_list = new_model._sample_finetune_gradient(eval_sp_size=100, copy_flag_temp=None) # [bsz, seqlen, 4]
