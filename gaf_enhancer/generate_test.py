...
# our model
CKPT_PATH = '/home/liangwei/zhl/DRAKES_lw/data/scratch/wangchy/seqft/mdlm/reward_bp_results_final/debug/model_999.ckpt'
...
# 存入 JSON 文件
with open("/home/liangwei/zhl/DRAKES_lw/drakes_dna/drake_model_dna.json", "w") as f:
    json.dump(all_detoeknized_samples, f)
# 读取 JSON 文件
with open("/home/liangwei/zhl/DRAKES_lw/drakes_dna/drake_model_dna.json", "r") as f:
    loaded_data = json.load(f)

# torch.save(all_raw_samples, "/home/liangwei/zhl/DRAKES_lw/drakes_dna/best_model_dna_one_hot.pt")

# 读取 `.pt` 文件
# loaded_tensor = torch.load("/home/liangwei/zhl/DRAKES_lw/drakes_dna/best_model_dna_one_hot.pt")
