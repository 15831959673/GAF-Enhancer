...
base_path = '/home/zhl/workspace/DRAKES/data/scratch/wangchy/seqft/'
df_train = pd.read_csv(f'/home/zhl/workspace/DRAKES/enhancer_250_EnhanerGAN/real_Sequence_activity_train.txt', sep='\t')
df_val = pd.read_csv(f'/home/zhl/workspace/DRAKES/enhancer_250_EnhanerGAN/real_Sequence_activity_val.txt', sep='\t')
